...
\begin{center}
    \huge{\textbf{TD6: Anneaux et morphismes d'anneaux}}
\end{center}
...
\begin{exo}
    ...
    \begin{q}{1}
        ...
        \boxans{\(A\) est trivialement stable par addition, contient la matrice
        nulle et \(I_2\). La stabilité par multiplication est à démontrée par les gens
        qui y sont forcés.}
    \end{q}
    \begin{q}{2}
