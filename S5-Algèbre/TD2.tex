...
\begin{center}
    \huge{\textbf{TD2: Groupes, sous-groupes}}
\end{center}
...
\begin{exo}
    ...
    \begin{q}{1}
        ...
        \boxans{Les conditions de l'énoncé nous indiquent que \(s=s^{-1}\)
        et que les éléments \(i,j\) et \(k\) sont distincts de leur inverse, ainsi.
        \(H = \left\{ i,i^{-1},j,j^{-1},k,k^{-1},s,e \right\}\subset G\). Montrons maintenant
        que \(G\) ne contient pas d'autre élément. Pour celà, on montre que tout produit
        de longueur \(2\) d'éléments générateur est dans \(H\).
    ...
    \begin{q}{2}
        \(G\) est-il abélien ?
        \boxans{Non, \(G\) n'est pas abélien, en effet \(i\star j \neq j\star i\).}
    \end{q}
    \begin{q}{3}
        Quels sont ses sous-groupes ?
        \boxans{
            On s'intéresse d'abord aux ordres des éléments qui sont
            \(o(i)=o(j)=o(k)=2o(s)=4o(e)=4\) aussi les sous groupes sont
            \begin{enumerate}
                \itt \(\left\{ e \right\}\)
                \itt \(\left\{ e, s \right\}\)
                \itt \(\left\{ i, i^2, i^3, i^4 \right\} =
                \left\{i, i^{-1}, s, e\right\}\) où \(i\) peut être remplacé par \(j\) ou \(k\)
            \end{enumerate}
            L'équation de \textsc{Lagrange} nous indique qu'on ne peut pas avoir de sous
            groupe plus grand car tout sous groupe de \(G\) doit avoir un cardinal qui
            divise celui de \(G\).
        }
    \end{q}
    \begin{q}{4}
        ...
        \boxans{
            \begin{enumerate}
                \itt(i) \(\begin{pmatrix}i&0\\0&-i\end{pmatrix}^2=
                \begin{pmatrix}i^2&0\\0&i^2\end{pmatrix}=\begin{pmatrix}-1&0\\0&-1\end{pmatrix}\)
                \itt(j) \(\begin{pmatrix}0&1\\-1&0\end{pmatrix}^2=
                \begin{pmatrix}1\times -1&0\\0&-1\times 1\end{pmatrix}=\begin{pmatrix}-1&0\\0&-1\end{pmatrix}\)
                \itt(k) \(\begin{pmatrix}0&i\\i&0\end{pmatrix}^2=
                \begin{pmatrix}i^2&0\\0&i^2\end{pmatrix}=\begin{pmatrix}-1&0\\0&-1\end{pmatrix}\)
                \itt \(\begin{pmatrix}i&0\\0&-i\end{pmatrix}\times \begin{pmatrix}0&i\\i&0\end{pmatrix}=
                \begin{pmatrix}0&1\times i\\-1\times -i&0\end{pmatrix}=\begin{pmatrix}0&i\\i&0\end{pmatrix}\)
            \end{enumerate}
