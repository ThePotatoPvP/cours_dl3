...
\begin{exo}
    ...
    3 bilingues anglais-toucan, et quatres personnes culturellement fermées, \(x=10\).}
\end{exo}
...
\begin{exo}
    Soient \(n,k\in\N^*\).
    \begin{q}{1}
        Combien y a-t-il d'uplets \(\left(x_1,\dots,x_n\right)\in\N^k\) tels que \(\sum x_i = n\)
    \end{q}
    \begin{q}{2}
...
\begin{exo}
    Soient \(n,k\in\N^*\). Combien y a-t-il d'uplets \(\left(x_1,\dots,x_n\right)\in\N^k\)
