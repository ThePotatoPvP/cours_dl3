...
\begin{exo}
    ...
    \boxans{On montre assez simplement par induction structurelle que toute formule
    se ramène à un arbre de profondeur 1, il est alors évident que l'on ne peut pas
    atteindre toutes les valeurs de vérités après les deux litéraux fixés.}
\end{exo}
...
\begin{exo}
    ...
    \begin{q}{1}
        ...
        \boxans{Le non est \(X\mapsto 1-X\), le ou est \(X,Y\mapsto X+Y-X*Y\), le et est
        \(X*Y\)}
    \end{q}
    \begin{q}{2}
