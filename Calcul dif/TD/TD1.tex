...
\begin{exo}
    ...
    \begin{q}{2}
        ...
        l'inégalité triangulaire. On peut le vérifier avec les vecteurs \(x_1=(1,0,0,...)\) et \(x_2=(0,1,0,...)\)}
    \end{q}
    \begin{q}{3}
...
\begin{exo}
    ...
    \boxans{
        \begin{enumerate}
            ...
            l'inégalité triangulaire ainsi le segment entre deux points de \(B_N\)
            est dans \(B_N\) qui est alors convexe.
        \end{enumerate}
    }
\end{exo}
...
\begin{exo}
    ...
    \boxans{Soient \(p_1, p_2\) vérifiant \(\left(|x_1|\leq|x_2|\right)\land
    \left(|y_1|\leq|y_2|\right)\) alors \(|x_1|+|y_1|\leq |x_2|+|y_2|\).
    L'équivalence des normes en dimension finie permet de conclure que la
    propriété est vraie, le point \(p_1\) est dans la boule de rayon \(p_2\).}
\end{exo}
