...
\begin{exo}
    ...
    \begin{q}{2}
        ...
        ne possède pas d'inverse dans \(H\) car \(a\land a+1=1\).}
    \end{q}
    \begin{q}{3}
...
\begin{exo}
    ...
    \begin{q}{2}
        ...
        \boxans{\begin{enumerate}
            ...
            ce qui implique \(aq=pb\) et donc \(aq-pb=0\), le groupe est cyclique
            et isomorphe à \(Z/p\Z\times \Z/q\Z\) il n'est donc pas dense dans \(\R\).
